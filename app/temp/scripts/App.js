...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.siteHeader = (0, _jquery2.default)('.site-header');
        this.headerTriggerElement = (0, _jquery2.default)('.large-hero__title'); //the header will change the colour once the hero title reaches the top edge
    ...
    _createClass(StickyHeader, [{
        ...
        value: function createHeaderWaypoint() {
            ...
            new Waypoint({
                ...
                handler: function handler(directon) {
                    if (directon == 'down') {
